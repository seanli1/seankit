...
public class SKFontManager {
    ...
    /// Add font to bundle.
    /// Copy its filename into Info.plist in a new row called "Fonts provided by application".
    /// Then run this function and look for the new font's name in the print statement.
